...
// GET /api/admin/cache-export/count?source=cache|list&listId=...
// GET /api/admin/cache-export/chunk?source=cache|list&listId=...&offset=0&limit=100000
...
// GET /api/admin/cache-export/lists — returns all lists with user info for the selector
