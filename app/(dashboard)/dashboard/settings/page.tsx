  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Administra las preferencias de tu cuenta</p>
      </div>
          ...
          <CardContent>
            <dl className="space-y-3 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <dd>{{ client: 'cliente', admin: 'administrador' }[user?.role as string] || user?.role || '—'}</dd>
              </div>
              <Separator />
              <div className="flex justify-between">
                <dt className="text-muted-foreground">Miembro desde</dt>
                <dd>{user?.created_at ? new Date(user.created_at).toLocaleDateString('es-CL') : '—'}</dd>
              </div>
            </dl>
          </CardContent>
        </Card>
