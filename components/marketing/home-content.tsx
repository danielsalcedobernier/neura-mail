            ...
            {tr.plans.map(plan => (
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <p className="text-xs text-white/30">{plan.credits} {lang === 'es' ? 'créditos' : 'credits'} · {plan.perK} {lang === 'es' ? 'por 1k' : 'per 1k'}</p>
                </div>
                ...
                <Link href="/register">
                  <Button size="sm" className={`w-full ${'popular' in plan && plan.popular ? 'bg-primary hover:bg-primary/90 text-white' : 'bg-white/10 hover:bg-white/20 text-white'}`}>
                    {plan.cta}
                  </Button>
                </Link>
              </div>
